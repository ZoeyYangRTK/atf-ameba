 ...
 *****************************************************************************/
#ifdef __aarch64__
#define AMEBA_CONFIGURE_BL1_MMU(...)	ameba_configure_mmu_el3(__VA_ARGS__)
#else
#define AMEBA_CONFIGURE_BL1_MMU(...)	ameba_configure_mmu_svc_mon(__VA_ARGS__)
#endif

void bl1_plat_arch_setup(void)
{
	AMEBA_CONFIGURE_BL1_MMU(bl1_tzram_layout.total_base,
