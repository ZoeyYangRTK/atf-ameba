...
#define MAP_FLASH0	MAP_REGION_FLAT(AMEBA_FLASH0_BASE, \
					AMEBA_FLASH0_SIZE, \
					MT_MEMORY | MT_RW | MT_SECURE)
 ...
 */
#if IMAGE_BL1
static const mmap_region_t plat_amebasmart_mmap[] = {
	MAP_FLASH0,
	MAP_SHARED_RAM,
	MAP_DEVICE0,
	MAP_DEVICE1,
 ...
 */
const mmap_region_t plat_amebasmart_mmap[] = {
	MAP_SHARED_RAM,
	MAP_DEVICE0,
	MAP_NS_DRAM0,
	MAP_DEVICE1,
...
#define DEFINE_CONFIGURE_MMU_EL(_el)					\
	void ameba_configure_mmu_##_el(unsigned long total_base,	\
